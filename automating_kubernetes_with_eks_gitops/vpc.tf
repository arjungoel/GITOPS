...
resource "aws_subnet" "public_subnet" {
  ...
  tags = {
    Name = "${var.default_tags.project_name}-public-${data.aws_availability_zones.available.names[0]}"
  }
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = {
    Name = "${var.default_tags.project_name}-private-${data.aws_availability_zones.available.names[1]}"
  }
